...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/baseDict_find.action"
		method=post>
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													<TD>分类名称：</TD>
													<TD>
														<s:textfield theme="simple" name="dict_type_name" cssClass="textbox" cssStyle="WIDTH: 80px" maxLength="50"></s:textfield>
													</TD>
