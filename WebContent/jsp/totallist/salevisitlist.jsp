...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/saleVisit_totalFindAll.action"
		method=post>
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													...
													<TD>拜访地点：</TD>
													<TD>
														<s:textfield theme="simple" name="visit_addr" cssClass="textbox" cssStyle="WIDTH: 80px" maxLength="50"></s:textfield>
													</TD>
													<TD>拜访详情：</TD>
													<TD>
														<s:textfield theme="simple" name="visit_detail" cssClass="textbox" cssStyle="WIDTH: 80px" maxLength="50"></s:textfield>
													</TD>
