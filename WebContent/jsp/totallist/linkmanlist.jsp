...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/linkMan_totalFindAll.action"
		method=post>
										...
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<TBODY>
												<TR>
													...
													<TD>手机：</TD>
													<TD>
														<s:textfield theme="simple" name="lkm_mobile" cssClass="textbox" cssStyle="WIDTH: 80px" maxLength="50"></s:textfield>
													</TD>
													<TD>邮箱：</TD>
													<TD>
														<s:textfield theme="simple" name="lkm_email" cssClass="textbox" cssStyle="WIDTH: 80px" maxLength="50"></s:textfield>
													</TD>
													<TD>QQ：</TD>
													<TD>
														<s:textfield theme="simple" name="lkm_qq" cssClass="textbox" cssStyle="WIDTH: 80px" maxLength="50"></s:textfield>
													</TD>
													<TD>职位：</TD>
													<TD>
														<s:textfield theme="simple" name="lkm_position" cssClass="textbox" cssStyle="WIDTH: 80px" maxLength="50"></s:textfield>
													</TD>
