...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/customer_totalFindAll.action"
		method=post>
											...
											<TBODY>
												<TR>
													...
													<TD>客户行业：</TD>
														...
														<TD>手机：</TD>
														<TD><INPUT class=textbox id=sChannel2
														style="WIDTH: 80px" maxLength=50 name="cust_mobile" value="<s:property value='model.cust_mobile'/>"></TD>
