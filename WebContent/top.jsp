							...
							<TBODY>
								...
								<TR>
									<TD height=35 align="right">
										当前业务员：<s:property value="#session.existUser.user_name"/>
										&nbsp;&nbsp;&nbsp;&nbsp;
										<A href="${pageContext.request.contextPath }/user_alterPasswordUI.action" target=_top><FONT color=red>修改密码</FONT></A>
										&nbsp;&nbsp;&nbsp;&nbsp;
