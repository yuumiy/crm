...
<TABLE cellSpacing=0 cellPadding=0 width=900 align=center border=0>
  ...
  border=0></TD></TR>
  <TR>
    <TD background=${ pageContext.request.contextPath }/images/regist_bt.png height=330>
        ...
        <TR>
          ...
          <TD>
            ...
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                <TD style="HEIGHT: 28px" width=80> 真实姓名 ：</TD>
                <TD style="HEIGHT: 28px" width=150><INPUT id=txtName 
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px"><INPUT id=txtcode 
                  style="WIDTH: 130px" name="user_yzm"></TD>
                <TD style="HEIGHT: 28px" ><img src="images/yzm.jpg" style="cursor:hand" height="28px"/></TD></TR>
              <TR>
